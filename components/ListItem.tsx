// componente Elementos dentro de una lista
...
const ListItem: React.FC<ListItemProps> = ({
    ...
    const onClick = ( ) => {
        // agregar autentificacion antes de presionar - add authentication before push
        router.push(href);
    }
    ...
    return ( 
        ...
        ">
            ...
            justify-center bg-purple-500 p-4 drop-shadow-md right-5 group-hover:opacity-100
            hover:scale-110
            ">
